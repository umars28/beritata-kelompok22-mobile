package com.example.kelompok22.beritata;
...
import com.example.kelompok22.beritata.Category.Science;
import com.example.kelompok22.beritata.Category.Sports;
import com.example.kelompok22.beritata.Category.Technology;
        ...
        api.getListAllNews("id", BuildConfig.NEWS_API_TOKEN).enqueue(new Callback<ResponseNews>() {
            ...
            public void onResponse(Call<ResponseNews> call, Response<ResponseNews> response) {
                if (response.isSuccessful()){
                    ...
                    hideDialog();
                    Toast.makeText(MainActivity.this, "Whooppsss... Ada kesalahan dalam sistem kami !", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ResponseNews> call, Throwable t) {
                hideDialog();
                Toast.makeText(MainActivity.this, "Silahkan periksan koneksi internet anda !", Toast.LENGTH_SHORT).show();
            }
        });
    }
